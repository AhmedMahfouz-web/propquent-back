        ...
        <div class="summary-cards mt-6 flex gap-4">
            ...
            <div class="flex-1 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4">
                ...
                <div class="space-y-2 text-sm">
                    ...
                    <!-- Status Breakdown -->
                    <div class="mt-3">
                        <h4 class="text-xs font-semibold text-gray-700 dark:text-gray-300 mb-2">By Status:</h4>
                        ...
                        <div class="flex justify-between pl-4">
                            <span class="text-green-500 dark:text-green-300 text-xs">Revenue:</span>
                            <span class="font-medium text-green-500 dark:text-green-300 font-mono text-xs">{{ number_format($tableSummary['revenue_done'], 2) }}</span>
                        </div>
                        <div class="flex justify-between pl-4">
                            <span class="text-red-500 dark:text-red-300 text-xs">Expense:</span>
                            <span class="font-medium text-red-500 dark:text-red-300 font-mono text-xs">({{ number_format($tableSummary['expense_done'], 2) }})</span>
                        </div>
                        <div class="flex justify-between pl-4">
                            <span class="text-gray-600 dark:text-gray-400 text-xs">Net:</span>
                            <span class="font-medium font-mono text-xs {{ $tableSummary['net_done'] >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400' }}">
                                {{ $tableSummary['net_done'] >= 0 ? number_format($tableSummary['net_done'], 2) : '(' . number_format(abs($tableSummary['net_done']), 2) . ')' }}
                            </span>
                        </div>
                        ...
                        <div class="flex justify-between pl-4">
                            <span class="text-green-500 dark:text-green-300 text-xs">Revenue:</span>
                            <span class="font-medium text-green-500 dark:text-green-300 font-mono text-xs">{{ number_format($tableSummary['revenue_pending'], 2) }}</span>
                        </div>
                        <div class="flex justify-between pl-4">
                            <span class="text-red-500 dark:text-red-300 text-xs">Expense:</span>
                            <span class="font-medium text-red-500 dark:text-red-300 font-mono text-xs">({{ number_format($tableSummary['expense_pending'], 2) }})</span>
                        </div>
                        <div class="flex justify-between pl-4">
                            <span class="text-gray-600 dark:text-gray-400 text-xs">Net:</span>
                            <span class="font-medium font-mono text-xs {{ $tableSummary['net_pending'] >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400' }}">
                                {{ $tableSummary['net_pending'] >= 0 ? number_format($tableSummary['net_pending'], 2) : '(' . number_format(abs($tableSummary['net_pending']), 2) . ')' }}
                            </span>
                        </div>
                        ...
                        <div class="flex justify-between pl-4">
                            <span class="text-green-500 dark:text-green-300 text-xs">Revenue:</span>
                            <span class="font-medium text-green-500 dark:text-green-300 font-mono text-xs">{{ number_format($tableSummary['revenue_cancelled'], 2) }}</span>
                        </div>
                        <div class="flex justify-between pl-4">
                            <span class="text-red-500 dark:text-red-300 text-xs">Expense:</span>
                            <span class="font-medium text-red-500 dark:text-red-300 font-mono text-xs">({{ number_format($tableSummary['expense_cancelled'], 2) }})</span>
                        </div>
                        <div class="flex justify-between pl-4">
                            <span class="text-gray-600 dark:text-gray-400 text-xs">Net:</span>
                            <span class="font-medium font-mono text-xs {{ $tableSummary['net_cancelled'] >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400' }}">
                                {{ $tableSummary['net_cancelled'] >= 0 ? number_format($tableSummary['net_cancelled'], 2) : '(' . number_format(abs($tableSummary['net_cancelled']), 2) . ')' }}
                            </span>
                        </div>
                        @endif
                    </div>
