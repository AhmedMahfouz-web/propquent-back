<x-filament-panels::page>
    ...
    <div class="space-y-6">
        ...
        <!-- Evaluation Grid -->
        <div class="evaluation-grid overflow-x-auto bg-white rounded-lg shadow-sm dark:bg-gray-800">
                            ...
                            @foreach ($availableMonths as $month)
                                ...
                                <td class="px-3 py-4 whitespace-nowrap">
                                    <x-filament::input type="number" step="0.01" min="0"
                                        wire:model.blur="evaluations.{{ $key }}" placeholder="0.00"
                                        class="w-32 text-right evaluation-input mx-auto" />
                                </td>
                            @endforeach
                        </tr>
                    @endforeach
