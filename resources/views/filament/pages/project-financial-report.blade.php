    ...
    <x-filament::section collapsible>
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-4">
            <div>
                ...
                <x-filament::input id="search" type="text" wire:model.live.debounce.300ms="search" placeholder="Search projects..." />
            </div>
            <div>
                <label for="startMonth" class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Start Month</label>
            ...
            <div>
                <label for="endMonth" class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">End Month</label>
            ...
            <div>
                <label for="perPage" class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Per Page</label>
            ...
            <div class="mt-6 overflow-x-auto bg-white rounded-lg shadow-sm dark:bg-gray-800">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead class="bg-gray-50 dark:bg-gray-700">
                        <tr>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider dark:text-gray-300 sticky left-0 bg-gray-50 dark:bg-gray-700 z-10">
                        ...
                        @forelse ($projects as $project)
                            ...
                            @if ($projectData)
                                @foreach ($metrics as $key => $label)
                                    <tr class="{{ $loop->first ? 'border-t-2 border-gray-300 dark:border-gray-600' : '' }} bg-white dark:bg-gray-800">
                                        @if ($loop->first)
                                            <td rowspan="{{ $rowspan }}" class="px-6 py-4 align-top whitespace-nowrap border-r dark:border-gray-600 sticky left-0 bg-white dark:bg-gray-800 z-10">
                            ...
                            <tr>
                                <td colspan="{{ 3 + count($allMonths) }}" class="px-6 py-12 whitespace-nowrap">
                                    <div class="text-center">
                                        ...
                                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">There are no projects to display.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
