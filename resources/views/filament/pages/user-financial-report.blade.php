                    ...
                    <div class="space-y-4">
                        ...
                        @if (isset($debugInfo['user_transactions_query']))
                            <div>
                                ...
                                <pre class="text-sm bg-white dark:bg-gray-800 p-2 rounded mt-1 overflow-x-auto">{{ json_encode($debugInfo['user_transactions_query'], JSON_PRETTY_PRINT) }}</pre>
                            </div>
                        @endif
                        
                        @if (isset($debugInfo['user_financials_calculated']))
                            <div>
                                <h4 class="font-medium text-yellow-700 dark:text-yellow-300">User Financials Calculated:</h4>
                                <pre class="text-sm bg-white dark:bg-gray-800 p-2 rounded mt-1 overflow-x-auto">{{ json_encode($debugInfo['user_financials_calculated'], JSON_PRETTY_PRINT) }}</pre>
                            </div>
                        @endif
